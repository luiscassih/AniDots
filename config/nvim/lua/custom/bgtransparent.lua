...
function ApplyThemeCustoms()
  ...
  vim.api.nvim_set_hl(0, "NoiceMiniNormalNC", bg_base_dark)
  vim.api.nvim_set_hl(0, "NoiceMiniFloatBorder", border)
  vim.api.nvim_set_hl(0, "DiagnosticVirtualTextInfo", bg_base_dark)
  vim.api.nvim_set_hl(0, "DiagnosticVirtualTextOk", bg_base_dark)
  vim.api.nvim_set_hl(0, "DiagnosticVirtualTextHint", bg_base_dark)
  vim.api.nvim_set_hl(0, "DiagnosticVirtualTextWarn", bg_base_dark)
  vim.api.nvim_set_hl(0, "DiagnosticVirtualTextError", bg_base_dark)
end
